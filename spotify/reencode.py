...
original_code = """from pyrogram import enums, types
...
# Replace "AloneX" with "spotify"
modified_code = original_code.replace("AloneX", "spotify")

# Re-encode
compressed = zlib.compress(modified_code.encode("utf-8"))
b64_encoded = base64.b64encode(compressed).decode("utf-8")
print("Re-encoded base64 string:")
print(b64_encoded)
